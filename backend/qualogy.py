...
#docker build -f Dockerfile.api -t qualogy-console-api .
#docker run --rm -p 5000:5000 qualogy-console-api 

# docker build -f Dockerfile.client -t qualogy-console-api .
